...
export default function Navbar() {
    ...
    <div className="navFrame flex-center-center jc-space-between">
            ...
            <div className="d-none">
                ...
                <Link ref={refUser} to="/sppage/user"/>
                <Link ref={refSetting} to="/sppage/basicdata"/>
                <Link ref={refPartner} to="/sppage/partner"/>
                <Link ref={refProduct} to="/sppage/product"/>
                <Link ref={refTransaction} to="/sppage/transaction"/>
                <Link ref={refTransactionLog} to="/sppage/transactionlog"/>
