...
const reloadAxiosAll=()=>{
    ...
    //console.log(`qry : ${qry}`)
    if(qry){
        //console.log(`qry.groupId : ${qry.groupId}`)
    }
    ...
    axios.post(`/${dataUrl}/getlimit`,
        ...
        .then(result=>{
            ...
            setTableTemplate(allTableTemplate[dataTableTemplateName])
            setDetailTableTemplate(allTableTemplate[detailTableTemplateName])
            setReloadData(false)
        })
        .catch(error=>{
